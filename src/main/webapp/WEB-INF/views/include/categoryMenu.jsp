  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
       ...
       -->
      <c:forEach items="${mainCateList }" var="categoryVO"><!-- foreach구문 안에 id를 설정한 태그를 넣으면, id가 중복된 여러 태그가 생기는 것. 안됨 -->
...
<script>
  ...
  $(function(){
    ...
    $("ul.navbar-nav li.nav-item div.subCateogory").on("click", "a", function(e){
      ...
      location.href = "/product/productList/" + cate_code + "/" +  encodeURIComponent(cate_name);//Rest 개발 방법론(주소 경로)
    });
  });
