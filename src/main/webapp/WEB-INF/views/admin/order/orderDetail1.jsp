        ...
        <h4>주문상세정보</h4>
        	<table class="table table-bordered">
        		...
        		<c:forEach items="${odList1}" var="orderDetailVOList">
	        		<tr>
	        			<td>${orderDetailVOList.odr_code }</td>
	        			<td>
						<img src="/admin/order/displayFile?folderName=${orderDetailVOList.pdt_img_folder }&fileName=s_${orderDetailVOList.pdt_img}" class="bd-placeholder-img card-img-top">
						<a class="move" href="${orderDetailVOList.pdt_num}" ><c:out value="${orderDetailVOList.pdt_name}" /></a>
           				</td> 
