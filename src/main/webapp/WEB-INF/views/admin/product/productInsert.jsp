...
<script>
  $(document).ready(function() {
    ...
    //1차 카테고리 선택을 바꾸면, 안의 내용들 하라
    $("#firstCategory").on("change", function(){
    	//console.log("1차 카테고리 코드 : " + $(this).val());
    	...
    	$.getJSON(url, function(secondData){
    		...
    		//다른 1차 카테고리를 선택할 때, 기존에 존재하는 2차 카테고리를 제거하는 용도
    ...
    $("#uploadFile").on("change", function(e){
      ...
      reader.readAsDataURL(file); //file reader객체에서 선택한 파일을 읽어 들이고 나면, onload이벤트가 동작된다.
    });
